      ...
      <form name="form2" method="post" action="<c:url value='/recipe/findByIngredients'/>" accept-charset="UTF-8" >
           <table>
              <tr>
                 ...
                 <td><input type="checkbox" name='ingredientList' value="깨">깨</td>
            </tr>
              ...
              <tr>
                 ...
                 <td><input type="checkbox" name='ingredientList' value="밥">밥</td>
              </tr>
              ...
              <tr>
                 ...
                 <td><input type="checkbox" name='ingredientList' value="옥수수콘">옥수수콘</td>
            </tr>
              ...
              <tr>
                 ...
                 <td><input type="checkbox" name='ingredientList' value="페퍼론치노">페퍼론치노</td>
            </tr>
