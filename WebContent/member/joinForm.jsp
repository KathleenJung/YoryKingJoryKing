     ...
     <td>
       ...
       <table>
         ...
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'"">
            <input type="text" style="width: 240;" name="memberId" placeholder="아이디를 입력하세요.">
         </td> 
        <tr height="40">
         ...
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'"">
            <input type="text" style="width: 240" name="m_name" placeholder="닉네임을 입력하세요."
                <c:if test="${registerFailed}">value="${mem.m_name}"</c:if>>
         </td>
        </tr>   
               <tr height="40">
         <td width="150" align="center" class="table-warning" style="font-family: 'BMJUA'">직업</td>
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'"">
            <input type="text" style="width: 240;" name="job" placeholder="직업을 입력하세요.">
         </td>
        </tr> 
          <tr height="40">
         ...
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'"">
            <input type="text" style="width: 240;" name="familyNum" placeholder="숫자로 입력하세요.">
         </td>
        </tr> 
           <tr height="40">
         ...
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'"">
            <input type="password" style="width: 240" name="password" placeholder="비밀번호를 입력하세요.">
         </td>
        </tr>
          <tr height="40">
         <td width="150" align="center" class="table-warning" style="font-family: 'BMJUA'">비밀번호 확인</td>
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'"">
            <input type="password" style="width: 240" name="password2" placeholder="비밀번호를 입력하세요.">
         </td>
        </tr>
       ...
       <table style="width: 100%">
        <tr>
         <td align="left">
         <input type="submit" value="회원 가입" onClick="memberCreate()" class="btn btn-secondary"> &nbsp;
         </td>
        </tr>
       </table>
     </td>
