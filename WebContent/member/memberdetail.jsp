    ...
    <tr>
     ...
     <td>
       ...
       <a href="<c:url value='/member/update/form'>
                 <c:param name='memberId' value='<%= dto.getMemberId()%>'/>
              </c:url>" style="font-family: 'NanumSquareRound';">수정</a> &nbsp;
        <a href="<c:url value='/member/delete'>
               <c:param name='memberId' value='<%= dto.getMemberId()%>'/>
              </c:url>" onclick="return memberRemove();" style="font-family: 'NanumSquareRound';">삭제</a> &nbsp;  
        <br><br>      
