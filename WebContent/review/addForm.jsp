...
<%
   ...
   String addrecipeid = (String) request.getParameter("addrecipeid");
%>
<html>
<head>
<title>레시피 추가</title>
...
<br>
<!-- registration form  -->
<form name="form" method="POST" action="<c:url value='/review/create' />" accept-charset="UTF-8">
  <input type="hidden" name="addrecipeid" value="<%=addrecipeid %>" />
  <table style="width: 100%">
    <tr>
     ...
     <td>
       <table>
        <tr>
          <td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>리뷰 추가</b>&nbsp;&nbsp;</td>
        </tr>
       </table>  
       <br>     
       ...
       <table>
          <tr height="40">
         <td width="150" align="center" class="table-warning" style="font-family: 'BMJUA'">리뷰 제목</td>
        ...
        <tr height="40">
         ...
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'">
            <input type="text" style="width: 240" name="stars"  placeholder="1/2/3/4/5">
         </td>
        </tr>
        <tr height="40">
         <td width="150" align="center" class="table-warning" style="font-family: 'BMJUA'">내용</td>
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'">
            <textarea  style="width: 240" name="content">
            </textarea>
         </td>
        </tr>
