...
<br>
<!-- registration form  -->
<form name="form" method="POST" action="<c:url value='/recipe/addRecipe' />" accept-charset="UTF-8">
     ...
     <td>
       ...
       <table>
         ...
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'">
            <input type="text" style="width: 240;" name="menuName">
         </td>
        </tr>
          <tr height="40">
         <td width="150" align="center" class="table-warning" style="font-family: 'BMJUA'">레시피 제목</td>
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'">
            <input type="text" style="width: 240" name="recipeTitle">
         </td>
        </tr>
        <tr height="40">
         <td width="150" align="center" class="table-warning" style="font-family: 'BMJUA'">분류</td>
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'">
            <input type="text" style="width: 240" name="menuNationality"  placeholder="한식/중식/일식/양식">
         </td>
        </tr>
        <tr height="40">
         ...
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'">
           ...
           <input type="checkbox" name='ingredientList' value="testIngre">
        ...
        <tr height="40">
         ...
         <td width="250" bgcolor="ffffff" style="padding-left: 10; font-family: 'NanumSquareRound'">
            <textarea  style="width: 240" name="recontent">
            </textarea>
         </td>
        </tr>
